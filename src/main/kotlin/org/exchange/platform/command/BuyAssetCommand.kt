...
data class BuyAssetCommand(
    @field:Schema(description = "Email of the account owner", example = "test@test.org")
    val accountEmail: String,
    @field:Schema(description = "Symbol of the asset to buy", example = "BTC")
    @field:NotBlank
    @field:AssetExistsType
    @field:ValidAssetType(allowFiat = false, message = "Not fiat allowed")
    val buyAssetSymbol: String,
    @field:Schema(description = "Symbol of the asset from", example = "BTC")
    @field:NotBlank
    @field:AssetExistsType
    val fromAssetSymbol: String,
    @field:Schema(description = "Amount to buy", example = "10.00")
